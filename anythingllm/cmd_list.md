# Lista Completa de Comandos - Ravena

Este arquivo contém a lista de todos os comandos disponíveis no bot Ravena, separados por categoria e tipo.

## 🛠️ Comandos Comuns (Fixed Commands)
Estes comandos podem ser usados por qualquer membro, a menos que especificado o contrário.
...
**Exemplo de utilização:** `!ana !ana <palpite>`
...
**Exemplo de utilização:** `!0800 !0800 [plataforma]`
...
**Exemplo de utilização:** `!giveaways !giveaways [plataforma]`
...
**Exemplo de utilização:** `!psn-platinas !psn-platinas <usuario>`
...
**Exemplo de utilização:** `!steam-platinas !platina <usuario/steamid>`
...
**Exemplo de utilização:** `!lastfm !lastfm username`
...
**Exemplo de utilização:** `!lfm !lfm username`
...
**Exemplo de utilização:** `!metar !metar <código_icao>`
...
**Exemplo de utilização:** `!audio !audio <nome_do_áudio> <número>`
...
**Exemplo de utilização:** `!sipt !sipt ABC1234`
...
**Exemplo de utilização:** `!horoscopo !horoscopo [signo] [data]`
...
**Exemplo de utilização:** `!news !news [YYYY-MM-DD]`
...
**Exemplo de utilização:** `!traduzir !traduzir [idiomaOriginal] [idiomaDesjado] [texto] ou !traduzir [idioma] em resposta a uma mensagem`
...
## ⚙️ Comandos de Gerenciamento (Admins de Grupo)
Estes comandos começam com o prefixo `g-` e são restritos a administradores de grupo.
...
## 👑 Comandos de Super Admin (Dono do Bot)
Estes comandos começam com o prefixo `sa-` e são exclusivos do desenvolvedor/dono do bot.
